...
<body>
    <div class="container">
        ...
        <div class="section">
            <h2>客戶互動歷史</h2>
            <div class="card">
                <strong>日期：</strong>2024-12-01<br>
                <strong>互動方式：</strong>電子郵件<br>
                <strong>摘要：</strong>提供課程進度提醒
            </div>
            <div class="card">
                <strong>日期：</strong>2024-12-05<br>
                <strong>互動方式：</strong>電話<br>
                <strong>摘要：</strong>解答課程內容疑問
            </div>
        </div>
    </div>
</body>
